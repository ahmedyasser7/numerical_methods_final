...
def Calculate(button_name, entry_function, entry_a, entry_b, entry_tol):
    # Convert data
    x = sp.Symbol('x')
...
def Calculate_Bisection_FP():
    pass


def Calculate_Trisection_FP():
    pass


def Calculate_ModSecant_FP():
    pass


def Calculate_FiniteDifference():
    pass
...
def Entries_bracketing(entry_function, entry_a, entry_b, entry_tol,
    ...
    btn_calc = Button(inner_frame, text="Calculate", command=lambda: Calculate(entry_function, entry_a, entry_b, entry_tol), font=Font, bg='#3349FF',
...
def Entries_BI_FP(entry_function, entry_x, entry_y, entry_degree,
                  lbl_function, lbl_x, lbl_y, lbl_degree):
    entry_function.grid(row=0, column=1, padx=(0, Padx), pady=Pady)
    entry_x.grid(row=1, column=1, padx=(0, Padx), pady=Pady)
    entry_y.grid(row=2, column=1, padx=(0, Padx), pady=Pady)
    ...
    btn_calc_BI_FP = Button(inner_frame, text="Calculate", command=lambda: Calculate_Bisection_FP(entry_function, entry_x, entry_y, entry_degree), font=Font, bg='#3349FF',
                            width=ButtonWidth, height=ButtonHeight)
    btn_calc_BI_FP.grid(row=6, column=0, columnspan=2,
                        padx=(Padx, 0), pady=Pady)


def Entries_Tri_FP(entry_function, entry_x, entry_y, entry_degree,
                   lbl_function, lbl_x, lbl_y, lbl_degree):
    entry_function.grid(row=0, column=1, padx=(0, Padx), pady=Pady)
    entry_x.grid(row=1, column=1, padx=(0, Padx), pady=Pady)
    entry_y.grid(row=2, column=1, padx=(0, Padx), pady=Pady)
    ...
    btn_calc_Tri_FP = Button(inner_frame, text="Calculate", command=lambda: Calculate_Trisection_FP(entry_function, entry_x, entry_y, entry_degree), font=Font, bg='#3349FF',
                             width=ButtonWidth, height=ButtonHeight)
    btn_calc_Tri_FP.grid(row=6, column=0, columnspan=2,
                         padx=(Padx, 0), pady=Pady)


def Entries_Mod_FP(entry_function, entry_x, entry_y, entry_degree,
                   lbl_function, lbl_x, lbl_y, lbl_degree):
    entry_function.grid(row=0, column=1, padx=(0, Padx), pady=Pady)
    entry_x.grid(row=1, column=1, padx=(0, Padx), pady=Pady)
    entry_y.grid(row=2, column=1, padx=(0, Padx), pady=Pady)
    ...
    btn_calc_Mod_FP = Button(inner_frame, text="Calculate", command=lambda: Calculate_ModSecant_FP(entry_function, entry_x, entry_y, entry_degree), font=Font, bg='#3349FF',
                             width=ButtonWidth, height=ButtonHeight)
...
def update_content(button_name):
    ...
    if button_name == "Bisection" or button_name == "False Position" or button_name == "Trisection":
        ...
        btn_calc = Button(inner_frame, text="Calculate", command=lambda: Calculate(button_name, entry_function, entry_a, entry_b, entry_tol), font=Font, bg='#3349FF',
                          width=ButtonWidth, height=ButtonHeight)
        btn_calc.grid(row=6, column=0, columnspan=2, padx=(Padx, 0), pady=Pady)
        ...
        Entries_BI_FP(entry_function, entry_x, entry_y, entry_degree,
                      lbl_function, lbl_x, lbl_y, lbl_degree)
        ...
        Entries_Tri_FP(entry_function, entry_x, entry_y, entry_degree,
                       lbl_function, lbl_x, lbl_y, lbl_degree)
        ...
        Entries_Mod_FP(entry_function, entry_x, entry_y, entry_degree,
                       lbl_function, lbl_x, lbl_y, lbl_degree)
...
def Main_frame():
    ...
    # Buttons
    btn_bisection = Button(button_frame, text="Bisection", command=lambda: update_content("Bisection"), font=Font, bg='#3349FF',
                           width=ButtonWidth, height=ButtonHeight)
    btn_bisection.pack(side=TOP, padx=Padx, pady=Pady)

    btn_FalsePosition = Button(button_frame, text="FalsePosition", command=lambda: update_content("False Position"), font=Font, bg='#3349FF',
                               width=ButtonWidth, height=ButtonHeight)
    btn_FalsePosition.pack(side=TOP, padx=Padx, pady=Pady)

    btn_Newton = Button(button_frame, text="Newton", command=lambda: update_content("Newton"), font=Font, bg='#3349FF', width=ButtonWidth,
                        height=ButtonHeight)
    btn_Newton.pack(side=TOP, padx=Padx, pady=Pady)

    btn_Secant = Button(button_frame, text="Secant", command=lambda: update_content("Secant"), font=Font, bg='#3349FF', width=ButtonWidth,
                        height=ButtonHeight)
    btn_Secant.pack(side=TOP, padx=Padx, pady=Pady)

    btn_Trisection = Button(button_frame, text="Trisection", command=lambda: update_content("Trisection"), font=Font, bg='#3349FF',
                            width=ButtonWidth, height=ButtonHeight)
    btn_Trisection.pack(side=TOP, padx=Padx, pady=Pady)

    btn_ModSecant = Button(button_frame, text="Mod Secant", command=lambda: update_content("Mod Secant"), font=Font, bg='#3349FF',
                           width=ButtonWidth, height=ButtonHeight)
    btn_ModSecant.pack(side=TOP, padx=Padx, pady=Pady)

    btn_Direct_Fit = Button(button_frame, text="Direct Fit", command=lambda: update_content("Direct Fit"), font=Font, bg='#3349FF',
                            width=ButtonWidth, height=ButtonHeight)
    btn_Direct_Fit.pack(side=TOP, padx=Padx, pady=Pady)

    btn_Larange = Button(button_frame, text="Lagrange", command=lambda: update_content("Lagrange"), font=Font, bg='#3349FF', width=ButtonWidth,
                         height=ButtonHeight)
    btn_Larange.pack(side=TOP, padx=Padx, pady=Pady)

    btn_BF = Button(button_frame, text="Bisection & FP", command=lambda: update_content("Bisection & False Position"), font=Font, bg='#3349FF',
                    width=ButtonWidth, height=ButtonHeight)
    btn_BF.pack(side=TOP, padx=Padx, pady=Pady)

    btn_TF = Button(button_frame, text="Trisection & FP", command=lambda: update_content("Trisection & False Position"), font=Font, bg='#3349FF',
                    width=ButtonWidth, height=ButtonHeight)
    ...
    btn_MOD_FP = Button(button_frame, text="Mod Secant & FP", command=lambda: update_content("Mod Secant & False Position"), font=Font,
                        bg='#3349FF', width=ButtonWidth, height=ButtonHeight)
    btn_MOD_FP.pack(side=TOP, padx=Padx, pady=Pady)

    btn_FD = Button(button_frame, text="Finite Difference", command=lambda: update_content("Finite Difference"), font=Font, bg='#3349FF',
                    width=ButtonWidth, height=ButtonHeight)
